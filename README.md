...
## ⚠️ Статус проекта:
Я вайб-кодер. Это не код, это поток сознания, работающий на моей машине. Я ухожу в Gentoo, так что проект ищет мейнтейнера. Делайте форки, допиливайте. Всё работает на Arch + Hyprland, на остальном — без понятия.
